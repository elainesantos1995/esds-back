...
public class EntrevistadorServiceImplTest {
	...
	@InjectMocks
	private EntrevistadorServiceImpl entrevistadorSocialServiceImpl;
	...
	public void testeSalvarFuncionarioComSucesso() {		
		Funcionario funcionarioSalvo = entrevistadorSocialServiceImpl.salvar(funcionario);		
	...
	public void testeAtualizarFuncionarioComSucesso() {
		...
		entrevistadorSocialServiceImpl.atualizar(1, funcionario);	
