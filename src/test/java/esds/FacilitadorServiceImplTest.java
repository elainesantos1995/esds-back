...
public class FacilitadorServiceImplTest {

	@InjectMocks
	private FacilitadorServiceImpl facilitadorServiceImpl;
	...
	public void testeSalvarFuncionarioComSucesso() {		
		Funcionario funcionarioSalvo = facilitadorServiceImpl.salvar(funcionario);		
	...
	public void testeAtualizarFuncionarioComSucesso() {
		...
		facilitadorServiceImpl.atualizar(1, funcionario);	
